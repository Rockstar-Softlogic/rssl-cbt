...
staffRoutes.route('/staff/exams/:id',{
	name: 'singleStaffExam',
	action(){
		BlazeLayout.render('dashboard',{content: 'singleStaffExam'});
	}
});
//////////////////////
////studentResult/////
///singleStudentResult////
///////////////////////
staffRoutes.route("/result/:id",{
	name:"studentResult",
	action(){
		BlazeLayout.render('dashboard',{content:"studentResult"});
	}
});

staffRoutes.route("/result/list/:id",{
	name:"resultList",
	action(){
